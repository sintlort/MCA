                                ...
                                <div class="dynamic-wrap">
                                    <form role="form" id="dynamic-form" autocomplete="off">
                                        <div class="entry input-group">
                                            ...
                                            <input class="form-control value_data" name="value[]" type="text"
...
<script>
    $('#dynamic-form').submit(function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: '{!! route('api-dynamic-yahoo-sort') !!}',
            data: {
                'category[]': input_name,
                'type[]': type,
                'value[]': value,
    ...
    $('#static-form').submit(function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: '{!! route('api-static-yahoo-sort') !!}',
            data: {
                'category': input_name,
                'type': type,
                'value': value,
